...
import { setRedirectAfterLogin } from '@redux/slices/authSlice';
...
const CartPage = () => {
  ...
  console.log('cart page>>', pathname);
    ...
    <PrivetRoute>
      <div className="mt-10">
        ...
        {totalProduct > 0 ? (
            ...
            <div className="flex-1 ">
              ...
              <div className="mt-5">
                <button
                  ...
                  className="px-6 py-2 bg-blue-700 text-white hover:bg-blue-800"
                >
                  Clear All
                </button>
              </div>
              ...
              <div className="flex justify-between">
                ...
                <div className="">
                  <p className="mb-1 text-lg font-bold">
                    $ {subtotalPrice > 0 ? totalPrice : 0} USD
                  </p>
          ...
          <div className="p-4 bg-blue-700 text-center w-2/12  m-auto text-white font-bold text-lg">
            Your Cart Is Empty
          </div>
        )}
      </div>
